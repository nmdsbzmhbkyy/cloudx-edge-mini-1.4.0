package com.aurine.cloudx.wjy.canal;//package com.aurine.dashboard.canal;
...
import com.aurine.cloudx.wjy.canal.config.CanalConfig;
import com.aurine.cloudx.wjy.canal.handle.AbstractCanalHandleChain;
...
public class CanalClient {
    ...
    public void connection(AbstractCanalHandleChain canalHandleChain) {
        if (canalConnector == null) {
            ...
            this.canalConnector = CanalConnectors.newSingleConnector(new InetSocketAddress(canalConfig.getHost(), canalConfig.getPort()), canalConfig.getDestination(), "", "");
            try {
