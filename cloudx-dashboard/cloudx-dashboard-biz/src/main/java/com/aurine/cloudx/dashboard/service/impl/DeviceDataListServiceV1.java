 ...
 */
@Service
public class DeviceDataListServiceV1 extends AbstractDashboardService {
    @Resource
    ...
    public JSONObject getData(DashboardRequestVo request) {
        ...
        if (StringUtils.equals(productTypeEnum.productMiddleType, "0203")) {//可视对讲类，从devieInfo查
            ...
            List<LinkedHashMap<String, Object>> dataMapList = deviceDataMapper.getDataByCode(productTypeEnum.tableName, request.getDeviceSn(), 7);
            if (CollUtil.isEmpty(dataMapList)) throw new DashboardException(DashboardErrorEnum.EMPTY_RESULT);

            VO vo = new VO();
            vo.setDataList(dataMapList);
    ...
    public String getServiceName() {
        return ServiceNameEnum.DEVICE_DATA_LIST.serviceName;
    }
