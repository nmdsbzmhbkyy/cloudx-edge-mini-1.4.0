package com.aurine.cloudx.common.core.util.canal;//package com.aurine.dashboard.canal;

import com.alibaba.otter.canal.client.CanalConnector;
import com.alibaba.otter.canal.client.CanalConnectors;
import com.alibaba.otter.canal.protocol.CanalEntry.*;
import com.alibaba.otter.canal.protocol.Message;
import com.aurine.cloudx.common.core.util.canal.handle.AbstractCanalHandleChain;
...
public class CanalClient {
    ...
    private AbstractCanalHandleChain canalHandleChain;

    private CanalConnector canalConnector = null;

    public CanalClient(CanalConfig canalConfig, AbstractCanalHandleChain canalHandleChain) {
        this.canalConfig = canalConfig;
        this.canalHandleChain = canalHandleChain;
    }
