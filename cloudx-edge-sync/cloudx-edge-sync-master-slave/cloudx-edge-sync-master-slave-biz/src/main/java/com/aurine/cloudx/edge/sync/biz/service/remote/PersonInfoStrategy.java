...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaPersonInfoService;
...
@Slf4j
@Component
public class PersonInfoStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaPersonInfoService remoteMetaPersonInfoService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPersonInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPersonInfoService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("personId", uuid);
        data.put("seq", null);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPersonInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPersonInfoService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaPersonInfoService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.PERSON_INFO.name, this);
    }
}
