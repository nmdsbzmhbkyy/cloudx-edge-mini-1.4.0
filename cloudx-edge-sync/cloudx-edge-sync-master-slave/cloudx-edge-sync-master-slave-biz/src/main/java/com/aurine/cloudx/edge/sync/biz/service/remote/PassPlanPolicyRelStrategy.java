...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaPassPlanPolicyRelService;
...
@Slf4j
@Component
public class PassPlanPolicyRelStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaPassPlanPolicyRelService remoteMetaPassPlanPolicyRelService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPassPlanPolicyRel.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPassPlanPolicyRelService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPassPlanPolicyRel.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPassPlanPolicyRelService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaPassPlanPolicyRelService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.PASS_PLAN_POLICY_REL.name, this);
    }
}
