...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaVisitorInfoService;
...
@Slf4j
@Component
public class VisitorInfoStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaVisitorInfoService remoteMetaVisitorInfoService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectVisitor.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaVisitorInfoService.save(openApiModel);
        ...
        String id = object.getString("visitorId");
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("visitorId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectVisitor.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaVisitorInfoService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaVisitorInfoService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.VISITOR_INFO.name, this);
    }
}
