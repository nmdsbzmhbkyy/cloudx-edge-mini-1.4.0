...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaLabelConfigService;
...
@Slf4j
@Component
public class LabelConfigStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaLabelConfigService remoteMetaLabelConfigService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectLabelConfig.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaLabelConfigService.save(openApiModel);
        ...
        String id = object.getString("labelId");
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("labelId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectLabelConfig.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaLabelConfigService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaLabelConfigService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.LABEL_CONFIG.name, this);
    }
}
