...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaHouseInfoService;
...
@Slf4j
@Component
public class HouseInfoStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaHouseInfoService remoteMetaHouseInfoService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectHouseInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaHouseInfoService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("houseId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectHouseInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaHouseInfoService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaHouseInfoService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.HOUSE_INFO.name, this);
    }
}
