...
public class CascadeApplyService {
    ...
    public R accept(String projectCode, OpenApiHeader openApiHeader) {
        ...
        R r = remoteCascadeEdgeApplyService.accept(openApiHeader, projectCode);
    ...
    public R reject(String projectCode, OpenApiHeader openApiHeader) {
        log.info("intoCloud -> openApi rejectApply req= {}", JSON.toJSONString(openApiHeader));
        R r = remoteCascadeEdgeApplyService.reject(openApiHeader, projectCode);
    ...
    public R revoke(String projectCode, OpenApiHeader openApiHeader) {
        ...
        R r = remoteCascadeEdgeApplyService.revoke(openApiHeader, projectCode);
