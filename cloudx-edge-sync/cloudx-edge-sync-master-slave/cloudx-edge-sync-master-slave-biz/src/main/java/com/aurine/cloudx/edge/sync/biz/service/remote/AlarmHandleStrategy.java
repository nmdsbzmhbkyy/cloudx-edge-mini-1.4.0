...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaAlarmHandleService;
...
@Slf4j
@Component
public class AlarmHandleStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaAlarmHandleService remoteMetaAlarmHandleService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectAlarmHandle.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaAlarmHandleService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectAlarmHandle.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaAlarmHandleService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaAlarmHandleService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.ALARM_HANDLE.name, this);
    }
}
