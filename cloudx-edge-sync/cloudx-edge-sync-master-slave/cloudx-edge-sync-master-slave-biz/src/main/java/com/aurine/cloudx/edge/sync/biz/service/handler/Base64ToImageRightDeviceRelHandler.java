...
@Component
@Slf4j
public class Base64ToImageRightDeviceRelHandler extends AbstractHandler<TaskInfoDto> {
    @Resource
    ...
    public boolean filter(TaskInfoDto handleEntity) {
        ...
        log.info("[边缘网关同步服务] {} Base64ToImage权限设备关系图片数据转换", handleEntity);
