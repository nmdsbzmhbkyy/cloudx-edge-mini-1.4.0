...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaHouseDesignService;
...
@Slf4j
@Component
public class HouseDesignStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaHouseDesignService remoteMetaHouseDesignService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectHouseDesign.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaHouseDesignService.save(openApiModel);
        ...
        String designId = object.getString("designId");
        return new OpenRespVo(designId, r);
    }
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("designId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectHouseDesign.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaHouseDesignService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaHouseDesignService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.HOUSE_DESIGN.name, this);
    }
}
