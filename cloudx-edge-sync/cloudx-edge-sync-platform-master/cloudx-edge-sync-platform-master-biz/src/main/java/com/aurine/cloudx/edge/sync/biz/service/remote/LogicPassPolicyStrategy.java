...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaLogicPassPolicyService;
...
@Slf4j
@Component
public class LogicPassPolicyStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaLogicPassPolicyService remoteMetaLogicPassPolicyService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectLogicPassPolicy.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaLogicPassPolicyService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectLogicPassPolicy.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaLogicPassPolicyService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaLogicPassPolicyService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.LOGIC_PASS_POLICY.name, this);
    }
}
