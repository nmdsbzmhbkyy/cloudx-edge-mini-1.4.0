...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaSnapRecordService;
...
@Slf4j
@Component
public class SnapRecordStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaSnapRecordService remoteMetaSnapRecordService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectSnapRecord.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaSnapRecordService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectSnapRecord.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaSnapRecordService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaSnapRecordService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.SNAP_RECORD.name, this);
    }
}
