...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaFaceInfoService;
...
@Slf4j
@Component
public class FaceInfoStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaFaceInfoService remoteMetaFaceInfoService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectFaceResources.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaFaceInfoService.save(openApiModel);
        ...
        String id = object.getString("faceId");
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("faceId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectFaceResources.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaFaceInfoService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaFaceInfoService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.FACE_INFO.name, this);
    }
}
