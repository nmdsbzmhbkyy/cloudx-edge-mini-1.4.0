...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaUnitInfoService;
...
@Slf4j
@Component
public class UnitInfoStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaUnitInfoService remoteMetaUnitInfoService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectUnitInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaUnitInfoService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("unitId", uuid);
        data.put("seq", null);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectUnitInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaUnitInfoService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaUnitInfoService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.UNIT_INFO.name, this);
    }
}
