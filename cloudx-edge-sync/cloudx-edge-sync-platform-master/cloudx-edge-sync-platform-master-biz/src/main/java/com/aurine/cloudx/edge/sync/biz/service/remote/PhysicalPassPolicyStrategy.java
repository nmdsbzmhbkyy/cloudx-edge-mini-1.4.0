...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaPhysicalPassPolicyService;
...
@Slf4j
@Component
public class PhysicalPassPolicyStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaPhysicalPassPolicyService remoteMetaPhysicalPassPolicyService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPhysicalPassPolicy.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPhysicalPassPolicyService.save(openApiModel);
        ...
        String id = object.getString("policyId");
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("policyId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPhysicalPassPolicy.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPhysicalPassPolicyService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaPhysicalPassPolicyService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.PHYSICAL_PASS_POLICY.name, this);
    }
}
