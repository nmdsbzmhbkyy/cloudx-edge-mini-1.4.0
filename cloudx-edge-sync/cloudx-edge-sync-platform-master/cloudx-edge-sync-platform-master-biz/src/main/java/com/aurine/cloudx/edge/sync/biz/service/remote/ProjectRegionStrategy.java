...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaProjectRegionService;
...
@Slf4j
@Component
public class ProjectRegionStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaProjectRegionService remoteMetaProjectRegionService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        R r = remoteMetaProjectRegionService.save(openApiModel);
        ...
        String id = object.getString("regionId");
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("regionId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectDeviceRegion.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaProjectRegionService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaProjectRegionService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.PROJECT_REGION.name, this);
    }
}
