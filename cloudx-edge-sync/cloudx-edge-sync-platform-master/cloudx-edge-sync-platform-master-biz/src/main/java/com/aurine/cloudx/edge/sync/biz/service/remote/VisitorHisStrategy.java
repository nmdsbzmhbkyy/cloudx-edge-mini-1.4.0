...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaVisitorHisService;
...
@Slf4j
@Component
public class VisitorHisStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaVisitorHisService remoteMetaVisitorHisService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectVisitorHis.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaVisitorHisService.save(openApiModel);
        ...
        String id = object.getString("visitId");
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("visitId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectVisitorHis.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaVisitorHisService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaVisitorHisService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.VISITOR_HIS.name, this);
    }
}
