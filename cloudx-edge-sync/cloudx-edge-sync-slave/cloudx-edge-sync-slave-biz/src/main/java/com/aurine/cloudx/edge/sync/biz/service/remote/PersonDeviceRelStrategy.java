...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaPersonDeviceRelService;
...
@Slf4j
@Component
public class PersonDeviceRelStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaPersonDeviceRelService remoteMetaPersonDeviceRelService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPersonDevice.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPersonDeviceRelService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPersonDevice.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPersonDeviceRelService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaPersonDeviceRelService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.PERSON_DEVICE_REL.name, this);
    }
}
