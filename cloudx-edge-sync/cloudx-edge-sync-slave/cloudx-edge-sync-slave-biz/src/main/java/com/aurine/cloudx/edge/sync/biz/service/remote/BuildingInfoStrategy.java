...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaBuildingInfoService;
...
@Slf4j
@Component
public class BuildingInfoStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaBuildingInfoService remoteMetaBuildingInfoService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectBuildingInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaBuildingInfoService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("buildingId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectBuildingInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaBuildingInfoService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaBuildingInfoService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.BUILDING_INFO.name, this);
    }
}
