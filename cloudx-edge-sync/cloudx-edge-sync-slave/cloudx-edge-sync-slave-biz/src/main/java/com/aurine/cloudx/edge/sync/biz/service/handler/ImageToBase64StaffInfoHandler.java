...
@Component
@Slf4j
public class ImageToBase64StaffInfoHandler extends AbstractHandler<TaskInfoDto> {
    /**
    ...
    public boolean filter(TaskInfoDto handleEntity) {
        ...
        log.info("[边缘网关同步服务] {} ImageToBase64员工信息图片数据转换", handleEntity);
    ...
    public boolean doHandle(TaskInfoDto handleEntity) {
        ...
        String picUrl = JSONObject.toJavaObject(jsonObj, ProjectStaff.class).getPicUrl();
