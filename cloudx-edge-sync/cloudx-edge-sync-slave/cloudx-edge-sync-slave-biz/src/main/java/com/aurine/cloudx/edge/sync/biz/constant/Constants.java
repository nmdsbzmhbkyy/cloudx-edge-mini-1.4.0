...
public class Constants {
    // ------------不同端代码不一致--------------
    /** topic主题 */
    public static final String PUBLISH_TOPIC_PREFIX = "edge/bridgeSlave/0000/%s/0/0/%s/%s";
    public static final String SUBSCRIBE_TOPIC_PREFIX = "edge/bridgeMaster/0000/%s/0/0/%s/+";
    /** redis标识 */
    private static final String BASE_KEY_PREFIX = "SLAVE_";
    /** 来源 */
    public static final String SOURCE = DataSourceEnum.SLAVE.name;
    /** 本地ip */
    public static final String LOCALHOST_IP = "cloudxedgesyncslave";
    /** 级联入云类型 */
    public static final String CASCADE_TYPE = CascadeDictEnum.CASCADE.name;
    /** 转发IP */
    public static final String TRANSFER_IP = "";
    /** 同步类型  */
    public static final Integer SYNC_TYPE = SyncTypeEnum.SECONDARY.code;
    /** 级联申请status字段名 */
    public static final String REQUEST_STATUS_NAME = "cascadeStatus";

    public static final String CONNECTION_STATUS = "ConnectionStatus_slave";
