...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaFrameInfoService;
...
@Slf4j
@Component
public class FrameInfoStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaFrameInfoService remoteMetaFrameInfoService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectFrameInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaFrameInfoService.save(openApiModel);
        ...
        String id = object.getString("entityId");
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        data.put("entityId", uuid);
        OpenApiModel openApiModel = new OpenApiModel();
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectFrameInfo.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaFrameInfoService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaFrameInfoService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.FRAME_INFO.name, this);
    }
}
