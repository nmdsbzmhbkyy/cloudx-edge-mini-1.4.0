...
import com.aurine.cloudx.open.api.inner.feign.RemoteMetaPersonPlanRelService;
...
@Slf4j
@Component
public class PersonPlanRelStrategy implements BaseStrategy {

    @Resource
    private RemoteMetaPersonPlanRelService remoteMetaPersonPlanRelService;
    ...
    public OpenRespVo doAdd(OpenApiModel<JSONObject> requestObj) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPersonPlanRel.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPersonPlanRelService.save(openApiModel);
    ...
    public OpenRespVo doUpdate(OpenApiModel<JSONObject> requestObj, String uuid) {
        ...
        openApiModel.setData(JSONObject.toJavaObject(requestObj.getData(), ProjectPersonPlanRel.class));
        openApiModel.setHeader(requestObj.getHeader());
        R r = remoteMetaPersonPlanRelService.update(openApiModel);
    ...
    public OpenRespVo doDelete(String appId, String projectUUID, Integer tenantId, String uuid) {
        ...
        R r = remoteMetaPersonPlanRelService.delete(appId, projectUUID, tenantId, uuid);
    ...
    public void afterPropertiesSet() throws Exception {
        BaseStrategyFactory.registerStrategy(ServiceNameEnum.PERSON_PLAN_REL.name, this);
    }
}
