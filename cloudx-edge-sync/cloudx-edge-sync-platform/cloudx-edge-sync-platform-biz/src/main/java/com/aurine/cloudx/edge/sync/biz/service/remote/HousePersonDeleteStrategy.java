...
@Slf4j
@Component
public class HousePersonDeleteStrategy implements CommandStrategy {
    ...
    public OpenRespVo doHandler(TaskInfoDto taskInfoDto) {
        ...
        jsonObject.put("type", TypeEnum.PERSON_DELETE.value);
    ...
    public void afterPropertiesSet() throws Exception {
        CommandStrategyFactory.registerStrategy(CommandTypeEnum.DELETE_HOUSE_PERSON.name, this);
    }
}
