...
/** Windows x 64 C库调用，目前集成了宇视人脸预识别库功能，这里做java层jna封装
 * @author chensl
 *
 */
interface IFaceDetectWin extends StdCallLibrary {
    final String libName = "facedetect";
    static IFaceDetectWin Instance = (IFaceDetectWin)Native.synchronizedLibrary(
            (IFaceDetectWin)Native.loadLibrary(libName, IFaceDetectWin.class)
    );
    /**
