...
@Data
@ApiModel("区口机信息视图")
public class ProjectDeviceInfoLadderVo extends ProjectDeviceInfoVo {
    /**
     * 楼栋id
     */
    @ApiModelProperty(value = "楼栋id,通过 building/list-with-group 接口获取")
     ...
     * 单元id
     */
    @ApiModelProperty(value = "单元id，通过 building-frame/list-puid 接口获取")
