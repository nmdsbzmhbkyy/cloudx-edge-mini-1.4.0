 ...
 */
@AllArgsConstructor
public enum HuaweiFaceResultCodeEnum {
    ...
    */
    public static HuaweiFaceResultCodeEnum getCertStatusByResult(String resultCode) {
        HuaweiFaceResultCodeEnum[] huaweiFaceResultCodeEnums = values();
        for (HuaweiFaceResultCodeEnum resultCodeEnum : huaweiFaceResultCodeEnums) {
            if (resultCodeEnum.resultCode.equals(resultCode)) {
                return resultCodeEnum;
            }
        }
        // 如果找不到则默认返回失败
        return HuaweiFaceResultCodeEnum.FAIL;
    }
