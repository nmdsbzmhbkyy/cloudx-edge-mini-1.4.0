...
public interface ProjectParkingPlaceService extends IService<ProjectParkingPlace> {
     ...
     * </p>
     *
     * @param placeIdList 车位ID集合
     * @author: 王良俊
     */
    boolean cancelParkingPlace(List<String> placeIdList);
    ...
    * </p>
    *
    * @param personId 所要查询可用车位的人员ID
    * @return 空闲的车位列表
    * @author: 王良俊
    */
    List<ProjectParkingPlace> getFreeParkingSpace(String personId);
}
