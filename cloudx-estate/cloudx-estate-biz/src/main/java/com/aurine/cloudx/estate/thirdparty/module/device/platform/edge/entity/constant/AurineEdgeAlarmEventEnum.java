 ...
 */
@AllArgsConstructor
public enum AurineEdgeAlarmEventEnum {
    ...
    public static AurineEdgeAlarmEventEnum getByCode(String code) {
        AurineEdgeAlarmEventEnum[] huaweiAlarmEventEnums = values();
        for (AurineEdgeAlarmEventEnum huaweiAlarmEventEnum : huaweiAlarmEventEnums) {
