...
public interface ProjectDeviceRegionService extends IService<ProjectDeviceRegion> {
     ...
     * @author: 王良俊
    */
    Page<ProjectBuildingRegionInfoVo> pageBuildingRegionInfo(Page<ProjectBuildingRegionInfoVo> page, String buildingName,String regionId,String regionName);
    ...
    */
     ...
     * @author: 王良俊
    */
    List<ProjectBuildingInfoVo> listBuildingByRegionId(String regionId);
    ...
    */
     ...
     *
     * @param key redis缓存键值
     * @param regionName 区域名 （多级区域使用','分隔）
     * @author: 王良俊
    */
    String getRegionIdByName(String key, String regionName);
     ...
     * @return
     */
    ProjectDeviceRegion getPublicRegion();
