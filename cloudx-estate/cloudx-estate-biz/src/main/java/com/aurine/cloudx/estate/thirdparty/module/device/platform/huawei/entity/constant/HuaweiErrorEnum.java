...
public enum HuaweiErrorEnum {
    ...
    public static HuaweiErrorEnum getByCode(String code) {
        HuaweiErrorEnum[] huaweiEventEnums = values();
        for (HuaweiErrorEnum huaweiEventEnum : huaweiEventEnums) {
            if (huaweiEventEnum.code().equals(code)) {
                return huaweiEventEnum;
            }
        }
        return HuaweiErrorEnum.FAIL;
    }
