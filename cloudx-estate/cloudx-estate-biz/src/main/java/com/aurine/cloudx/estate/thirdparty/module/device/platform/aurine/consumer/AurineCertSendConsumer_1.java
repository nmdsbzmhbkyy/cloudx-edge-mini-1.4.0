...
//@Component
@Slf4j
public class AurineCertSendConsumer_1 {
    @Resource
    private AurineCertSendHandleV2_1 aurineCertSendHandleV2_1;


//    @KafkaListener(topics = AurineTocpicConstant.PREFIX_DRVICE_CERT_TOPIC + "1", errorHandler = "", containerFactory = "kafkaListenerContainerFactory")
    public void readActiveQueue(String message) {
        log.info("冠林中台 执行凭证下发 通道 1 ：{}", message);
