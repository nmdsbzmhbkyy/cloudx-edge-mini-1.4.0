...
@ToOpenApi(serviceType = OpenPushSubscribeCallbackTypeEnum.OPERATE, serviceName = OpenApiServiceNameEnum.PROJECT_REGION)
@Mapper
//@CacheNamespace
public interface ProjectDeviceRegionMapper extends BaseMapper<ProjectDeviceRegion> {
    ...
    */
     ...
     * @author: 王良俊
    */
    List<ProjectBuildingInfoVo> listBuildingByRegionId(@Param("regionId") String regionId, @Param("isGroup") boolean isGroup, @Param("isPublicRegion") boolean isPublicRegion);
