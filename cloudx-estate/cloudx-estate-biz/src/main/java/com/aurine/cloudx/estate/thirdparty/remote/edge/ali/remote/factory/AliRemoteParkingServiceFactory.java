 ...
 * <p> </p>
 *
 * @ClassName: AliRemoteParkingServiceFactory
 * @author: 王伟 <wangwei@aurine.cn>
 * @date: 2021-06-09 16:55
 * @Copyright:
 */
@Component
public class AliRemoteParkingServiceFactory implements ApplicationContextAware {

    static Map<String, AliRemoteParkingService> instanceMap;
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        Map<String, AliRemoteParkingService> map = applicationContext.getBeansOfType(AliRemoteParkingService.class);
     ...
     * @return
     */
    public static AliRemoteParkingService getInstance(VersionEnum versionEnum) {
