 ...
 */
@AllArgsConstructor
public enum AurineEdgeLiftEventEnum {

    OPEN_DOOR_KEY("401000", "钥匙乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_PSW("401001", "密码乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_CARD("401002", "刷卡乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_FINGER("401003", "指纹乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_VISITOR("401006", "访客乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_MONITOR("401007", "监视乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_BY_PHONE("401008", "手机一键乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_FACE("401004", "人脸识别乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_TEMP("401009", "临时授权乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_REMOTE("401011", "远程一键乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_BLUETOOTH("401012", "手机蓝牙乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_BY_SHARE("401013", "分享密码乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_QR("401020", "住户二维码乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_QR_AUTH("401021", "授权二维码乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_QR_TEMP("401022", "临时二维码乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_CHECK_BY_HUMAN("401030", "人证核验乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_CALL_INDOOR("401050", "访客呼叫室内机乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_CALL_PHONE("401051", "访客呼叫手机乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_CALL_CENTER("401052", "呼叫中心乘梯", "DjOpenDoorEvent", "人行进门事件"),
    OPEN_DOOR_EXIT_BUTTON("401053", "出门按钮乘梯", "DjOpenDoorEvent", "人行进门事件"),
    ...
    ALERT_OPENDOOR_FORCE("401210", "强行开门", "DjAlarmEvent", "报警事件"),
    ...
    ALERT_DEFENCE_AREA_ERROR("401400","防区触发报警","DjAlarmEvent","报警事件"),
    ALERT_HITCH_AREA_ERROR("401401","防区故障报警","DjAlarmEvent","报警事件"),
    ALERT_DESTROY_AREA_ERROR("401402","防区破坏报警","DjAlarmEvent","报警事件"),

    ALERT_SOS_ALARM("401403","SOS报警","DjAlarmEvent","报警事件"),
    ...
    ALERT_GATHER_ALARM("901008", "人员聚集", "AIFQControlEvent", "安防管控事件"),

    CALL_RECORD("401301", "通话记录", "DjTalkRecordEvent", "通话记录"),
    PERIMETER_ALARM_RECORD("801000","周界通道告警","channelAlarm","通道报警事件"),
    PERIMETER_ALARM_REMOVE("802000","周界报警解除","alarmRemove","报警解除事件"),
    ;
    ...
    public static AurineEdgeLiftEventEnum getByCode(String code) {
        AurineEdgeLiftEventEnum[] huaweiEventEnums = values();
        for (AurineEdgeLiftEventEnum huaweiEventEnum : huaweiEventEnums) {
