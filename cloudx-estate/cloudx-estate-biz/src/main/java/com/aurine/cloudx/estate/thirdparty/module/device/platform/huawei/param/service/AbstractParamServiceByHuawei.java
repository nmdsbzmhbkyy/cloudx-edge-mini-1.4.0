package com.aurine.cloudx.estate.thirdparty.module.device.platform.huawei.param.service;
 ...
 *
 * @author : 王良俊
 * @date : 2021-07-07 09:52:26
 */
@Service
public abstract class AbstractParamServiceByHuawei extends AbstractDeviceParamService {

    @Override
    public abstract DevicesResultVo multiDeviceParamSetting(ObjectNode paramsNode, List<String> deviceIdList, List<String> serviceIdList);
    ...
    public void requestDeviceParam(Set<String> serviceIdList, String deviceId) {
        ...
        serviceIdSet.add(HuaweiServiceEnum.DEVICE_INFO.code);
