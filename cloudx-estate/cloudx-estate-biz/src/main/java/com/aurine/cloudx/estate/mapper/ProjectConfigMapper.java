 ...
 */
@Mapper
@ToOpenApi(serviceType = OpenPushSubscribeCallbackTypeEnum.OPERATE, serviceName = OpenApiServiceNameEnum.PROJECT_CONFIG)
public interface ProjectConfigMapper extends BaseMapper<ProjectConfig> {
     ...
     */
    @SqlParser(filter = true)
    void updateLiftEnable(@Param("projectId") Integer projectId, @Param("value") String value);
}
