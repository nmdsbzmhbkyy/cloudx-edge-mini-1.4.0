 ...
 */
@Component
public class DeviceHuaweiFactory extends AbstractDeviceFactory implements ApplicationContextAware {

    private static DeviceHuaweiFactory factoryInstance;//工厂单例
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        //注入工厂实现
        DeviceHuaweiFactory.factoryInstance = applicationContext.getBean(DeviceHuaweiFactory.class);
    ...
    public PassWayDeviceService getPassWayDeviceService() {
        if (passWayDeviceServiceInstanceMap.get(versionEnum.code) == null){
            throw new RuntimeException("未找到huawei PassWayDeviceService 实例:" + versionEnum.code);
        }
    ...
    public IotDeviceService getIotDeviceService() {
        if (iotDeviceServiceMap.get(versionEnum.code) == null) {
            throw new RuntimeException("未找到huawei IotDeviceService 实例:" + versionEnum.code);
        }
    ...
    public DeviceService getDeviceService() {
        if (deviceServiceInstanceMap.get(versionEnum.code) == null){
            throw new RuntimeException("未找到huawei DeviceService 实例:" + versionEnum.code);
        }
    ...
    private <T extends BaseService> void initBean(Class<T> t, Map instanceMap, ApplicationContext applicationContext) throws BeansException {
        ...
        beanMap.forEach((key, instance) -> {
            if (instance.getPlatform().equals(PlatformEnum.HUAWEI_MIDDLE.code)) {
