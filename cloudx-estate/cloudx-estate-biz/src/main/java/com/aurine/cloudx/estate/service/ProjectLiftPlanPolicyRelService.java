 ...
 */
@Component
public interface ProjectLiftPlanPolicyRelService extends IService<ProjectLiftPlanPolicyRel> {

//    /**
//     * 根据方案,获取该方案下所有可以使用的设备
//     *
//     * @param projectLiftPlan
//     * @param buildingId
//     * @param unitId
//     * @return
//     */
//    List<ProjectLiftFloorVo> listDeviceByPlan(ProjectLiftPlan projectLiftPlan, String buildingId, String unitId);
    ...
    /**
     * 通过方案ID，获取该方案的物理策略的楼层数组
     *
     * @param planId
     * @return
     */
    String[] listPhysicalFloorArrayByPlanId(String planId);
...
//     * @return
//     */
//    List<ProjectLiftDeviceVo> listPhysicalDeviceListByPlanId(String planId);
     ...
     * @return
     */
    boolean saveBatchPhysical(String[] floorArray, String planId);
