...
//        projectConfig.setProjectId(projectId);
    ...
    public ProjectConfig getByProjectId(Integer projectId) {
        ProjectConfig projectConfig = baseMapper.getByProjectId(projectId);
        if(projectConfig.getLiftEncryptKey() == null){
            projectConfig.setLiftEncryptKey(liftCardConfig.getProjectSecret());
        }
    ...
    @Override
    public void updateLiftEnable(Integer projectId, String liftEnable) {
        baseMapper.updateLiftEnable(projectId,liftEnable);
    }
