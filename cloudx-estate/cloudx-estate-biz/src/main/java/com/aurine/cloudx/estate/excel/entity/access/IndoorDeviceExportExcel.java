...
public class IndoorDeviceExportExcel {
    ...
    @ExcelValid(fieldName = "子网掩码", required = true, maxLength = 32, regex = ExcelRegexConstants.SUBNET, regexTip = "子网掩码格式填写错误，正确格式\"255.255.255.0\"")
    ...
    @ExcelValid(fieldName = "默认网关", required = true, maxLength = 32, regexTip = "默认网关格式填写错误，正确格式\"192.168.0.254\"")
    private String gateway;

    /**
     * dns1
     */
    @ExcelProperty(value = "dns1地址")
    @ExcelValid(fieldName = "dns1地址", required = true, maxLength = 32, regex = ExcelRegexConstants.IPV4, regexTip = "dns1格式填写错误，正确格式\"114.114.114.114\"")
    private String dns1;

    /**
     * dns2
     */
    @ExcelProperty(value = "dns2地址")
     ...
     * 中心服务器地址
     */
    @ExcelProperty(value = "中心服务器地址")
    @ExcelValid(fieldName = "中心服务器地址", required = true, maxLength = 32, regex = ExcelRegexConstants.IPV4, regexTip = "中心服务器地址格式填写错误，正确格式\"192.168.10.1\"")
