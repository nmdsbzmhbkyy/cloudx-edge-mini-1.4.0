 ...
 */
@AllArgsConstructor
public enum AurineEdgeCallTypeEnum {
    ...
    public static AurineEdgeCallTypeEnum getByCode(String code) {
        AurineEdgeCallTypeEnum[] huaweiEventEnums = values();
        for (AurineEdgeCallTypeEnum huaweiEventEnum : huaweiEventEnums) {
