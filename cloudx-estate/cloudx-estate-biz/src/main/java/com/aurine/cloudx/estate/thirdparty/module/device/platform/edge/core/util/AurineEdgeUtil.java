package com.aurine.cloudx.estate.thirdparty.module.device.platform.edge.core.util;
...
import com.aurine.cloudx.estate.thirdparty.module.device.platform.edge.entity.constant.AurineEdgeMethodConstant;
...
//        sign = "Basic " + DigestUtils.md5DigestAsHex(sign.getBytes());
     ...
     * @return
     */
    public static AurineEdgeRequestObject createPostRequestObject(AurineEdgeConfigDTO configDTO, String uri, JSONArray requestJson, String version) {
        return createRequestObject(configDTO, uri, null, requestJson, version, AurineEdgeMethodConstant.POST);
    }
     ...
     * @return
     */
    public static AurineEdgeRequestObject createPostRequestObject(AurineEdgeConfigDTO configDTO, String uri, JSONArray requestJson, String version, JSONObject otherParams) {
        return createRequestObject(configDTO, uri, null, requestJson, version, AurineEdgeMethodConstant.POST, otherParams,null);
    }
     ...
     * @return
     */
    public static AurineEdgeRequestObject createPostRequestObject(AurineEdgeConfigDTO configDTO, String uri, JSONObject requestJson, String version) {
        return createRequestObject(configDTO, uri, requestJson, null, version, AurineEdgeMethodConstant.POST);
    }
     ...
     * @return
     */
    public static AurineEdgeRequestObject createPostRequestObject(AurineEdgeConfigDTO configDTO, String uri, JSONObject requestJson, String version, JSONObject otherParams,String msgId) {
        return createRequestObject(configDTO, uri, requestJson, null, version, AurineEdgeMethodConstant.POST, otherParams,msgId);
    }
     ...
     * @return
     */
    public static AurineEdgeRequestObject createGetRequestObject(AurineEdgeConfigDTO configDTO, String uri, JSONObject requestJson, String version) {
        return createRequestObject(configDTO, uri, requestJson, null, version, AurineEdgeMethodConstant.GET);
    }
     ...
     * @return
     */
    public static AurineEdgeRequestObject createGetRequestObject(AurineEdgeConfigDTO configDTO, String uri, JSONObject requestJson, String version, JSONObject otherParams) {
        return createRequestObject(configDTO, uri, requestJson, null, version, AurineEdgeMethodConstant.GET, otherParams,null);
    }

    private static AurineEdgeRequestObject createRequestObject(AurineEdgeConfigDTO configDTO, String uri, JSONObject requestJson, JSONArray requestJsonArray, String version, String method) {
...
//        String uid = UUID.randomUUID().toString().replaceAll("-", "").substring(0, 19);
        ...
        //针对post指令，设置msgId
        if ((requestJson != null || requestJsonArray != null) && AurineEdgeMethodConstant.POST.equalsIgnoreCase(method)) {
            requestJson.put("msgId", uid);
        }

        AurineEdgeRequestObject obj = new AurineEdgeRequestObject();
...
//        obj.setProjectId(ProjectContextHolder.getProjectId());
        //配置到缓存中
        RedisUtil.set(AurineEdgeCacheConstant.AURINE_EDGE_REQUEST_PER + uid, JSON.toJSONString(obj), AurineEdgeCacheConstant.AURINE_EDGE_REQUEST_MSG_TTL);
     ...
     * @return
     */
    private static AurineEdgeRequestObject createRequestObject(AurineEdgeConfigDTO configDTO, String uri, JSONObject requestJson, JSONArray requestJsonArray, String version, String method, JSONObject otherParams,String msgId) {


        String uid = UUID.randomUUID().toString().replaceAll("-", "");
//        String uid = UUID.randomUUID().toString().replaceAll("-", "").substring(0, 19);
        if(StrUtil.isEmpty(requestJson.getString("msgId"))){
            //针对post指令，设置msgId
            if ((requestJson != null || requestJsonArray != null) && AurineEdgeMethodConstant.POST.equalsIgnoreCase(method)) {
                requestJson.put("msgId", uid);
            }
        ...
        obj.setRequestJson(requestJson);
        obj.setRequestJsonArray(requestJsonArray);
        obj.setMessageId(msgId != null ? msgId : uid);
        obj.setConfig(configDTO);
        obj.setProjectId(ProjectContextHolder.getProjectId());
        ...
        //配置到缓存中
        log.debug("数据存到redis缓存中 Key：{} Data：{}",  AurineEdgeCacheConstant.AURINE_EDGE_REQUEST_PER + (msgId != null ? msgId : uid), JSON.toJSONString(obj));
        RedisUtil.set(AurineEdgeCacheConstant.AURINE_EDGE_REQUEST_PER + (msgId != null ? msgId : uid), JSON.toJSONString(obj), AurineEdgeCacheConstant.AURINE_EDGE_REQUEST_MSG_TTL);
