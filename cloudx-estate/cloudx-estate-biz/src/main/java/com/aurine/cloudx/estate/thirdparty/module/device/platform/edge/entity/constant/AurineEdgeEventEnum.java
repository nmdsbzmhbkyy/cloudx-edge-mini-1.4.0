 ...
 */
@AllArgsConstructor
public enum AurineEdgeEventEnum {
    ...
    REMOTE_VALID_DOOR_OPEN("401023", "远端校验开门", "DjOpenDoorEvent", "人行进门事件"),
    ...
    ABNORMA_FACE_BLACKLIST("401111", "黑名单人脸", "DjAbnormalEvent", "异常事件"),
...
//    ABNORMA_WRONG_CARD("401102", "无效卡刷卡", "DjAbnormalEvent", "异常事件"),
    ...
    public static AurineEdgeEventEnum getByCode(String code) {
        AurineEdgeEventEnum[] huaweiEventEnums = values();
        for (AurineEdgeEventEnum huaweiEventEnum : huaweiEventEnums) {
