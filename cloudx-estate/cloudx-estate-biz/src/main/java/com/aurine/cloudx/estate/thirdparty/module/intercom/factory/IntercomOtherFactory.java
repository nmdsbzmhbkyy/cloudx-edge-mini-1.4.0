 ...
 */
@Component
public class IntercomOtherFactory extends AbstractIntercomFactory implements ApplicationContextAware {

    private static IntercomOtherFactory factoryInstance;//工厂单例
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        //注入工厂实现
        IntercomOtherFactory.factoryInstance = applicationContext.getBean(IntercomOtherFactory.class);
