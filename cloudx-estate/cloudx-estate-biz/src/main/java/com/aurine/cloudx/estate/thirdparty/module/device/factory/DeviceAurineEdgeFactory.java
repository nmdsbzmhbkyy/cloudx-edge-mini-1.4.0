 ...
 */
@Component
public class DeviceAurineEdgeFactory extends AbstractDeviceFactory implements ApplicationContextAware {

    private static DeviceAurineEdgeFactory factoryInstance;//工厂单例
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        //注入工厂实现
        DeviceAurineEdgeFactory.factoryInstance = applicationContext.getBean(DeviceAurineEdgeFactory.class);
    ...
    private <T extends BaseService> void initBean(Class<T> t, Map instanceMap, ApplicationContext applicationContext) throws BeansException {
        ...
        beanMap.forEach((key, instance) -> {
            if (instance.getPlatform().equals(PlatformEnum.AURINE_EDGE_MIDDLE.code)) {
