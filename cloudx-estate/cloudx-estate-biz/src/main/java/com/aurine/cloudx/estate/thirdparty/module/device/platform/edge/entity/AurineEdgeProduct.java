package com.aurine.cloudx.estate.thirdparty.module.device.platform.edge.entity;
 ...
 */
@Data
public class AurineEdgeProduct {

    private String productId; //产品ID	string	是	产品的唯一标识
