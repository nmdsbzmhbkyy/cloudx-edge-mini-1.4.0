 ...
 */
@ToOpenApi(serviceType = OpenPushSubscribeCallbackTypeEnum.OPERATE, serviceName = OpenApiServiceNameEnum.HOUSE_PERSON_INFO)
@Mapper
...
//    IPage<ProjectHousePersonRelRecodeVo> select(IPage<?> page,String buildingName,String houseName,String unitName,String personName);
    ...
    String getVisitorHouseName(@Param("visitHouseId") String visitHouseId);
}
