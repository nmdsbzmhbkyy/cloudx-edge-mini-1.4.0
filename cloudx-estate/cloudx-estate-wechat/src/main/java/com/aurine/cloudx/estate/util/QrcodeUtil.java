...
public class QrcodeUtil {
    ...
    public String decrypt(String val) throws Exception {
        String deString = new SecurityCore().decrypt(val);
        return deString;
    }
...
//    public static void main(String[] args) throws Exception {
//        System.out.println(QrcodeUtil.getInstance().decrypt("VWARtfZ0ygkjaNnJXHN9018byxGEH2p752Gb/S382lMRvsf4iZGI1NEYhM5p2fniTdSH6Mld1b5dUuQfR/PXsLqLGXoKmyKnIWjPNjsyzX4"));
//    }
}
