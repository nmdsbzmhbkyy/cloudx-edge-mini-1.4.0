...
@Data
@ApiModel(value = "人员信息")
public class ProjectPersonInfoVo extends ProjectFocusPersonAttr {
     ...
     * 人员拓展属性
     */
    @ApiModelProperty("人员拓展属性")
    private List<ProjectPersonAttrListVo> projectPersonAttrListVoList;
