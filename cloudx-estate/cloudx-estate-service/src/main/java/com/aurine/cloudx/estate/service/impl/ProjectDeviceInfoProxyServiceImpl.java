...
public class ProjectDeviceInfoProxyServiceImpl extends ServiceImpl<ProjectDeviceInfoMapper, ProjectDeviceInfo> implements ProjectDeviceInfoProxyService {
     ...
     */
    @Override
    public boolean saveOrUpdateDeviceByDeviceCode(ProjectDeviceInfoProxyVo deviceInfoProxyVo) {
        List<ProjectDeviceInfo> deviceList = this.baseMapper.selectList(new QueryWrapper<ProjectDeviceInfo>().lambda().eq(ProjectDeviceInfo::getThirdpartyCode, deviceInfoProxyVo.getThirdpartyCode()));
     ...
     */
    @Override
    public ProjectDeviceInfoProxyVo getByDeviceCode(String deviceCode) {
        return this.baseMapper.getByDeviceCode(deviceCode);
    }
     ...
     */
    @Override
    public Integer countDeviceCode(String deviceCode) {
        return this.baseMapper.countThirdPartyCode(deviceCode);
    }
