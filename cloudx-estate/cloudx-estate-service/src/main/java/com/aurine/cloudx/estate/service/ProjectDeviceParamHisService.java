...
public interface ProjectDeviceParamHisService extends IService<ProjectDeviceParamHis> {
     ...
     * @author: 王良俊
     */
    void addFailedParamHis(List<ProjectDeviceInfo> deviceInfoList);
     ...
     * @author: 王良俊
     */
    void addSuccessParamHis(List<ProjectDeviceInfo> deviceInfoList);
     ...
     * @author: 王良俊
     */
    void updateSuccessParamHis(List<String> deviceIdList);
}