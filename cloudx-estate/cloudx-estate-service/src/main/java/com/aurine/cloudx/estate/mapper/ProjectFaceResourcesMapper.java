...
public interface ProjectFaceResourcesMapper extends BaseMapper<ProjectFaceResources> {
     ...
     *
     */
    Page<ProjectFaceResourceAppPageVo> getCurrentUserCreatePage (Page page, @Param("projectId") Integer projectId, @Param("dlStatus") String dlStatus, @Param("userId") Integer userId);
