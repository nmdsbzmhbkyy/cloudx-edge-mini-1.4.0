...
import com.aurine.cloudx.estate.vo.ProjectAddressParamVo;
import com.aurine.cloudx.estate.vo.ProjectInfoByAdminFormVo;
import com.aurine.cloudx.estate.vo.ProjectInfoPageVo;
import com.aurine.cloudx.estate.vo.ProjectInfoSimplePageVo;
...
public interface ProjectInfoMapper extends BaseMapper<ProjectInfo> {
     ...
     * @return
     */
    Page<ProjectInfoPageVo> pageProjectByStaff(Page page, @Param("userId") Integer userId, @Param("projectId") String projectId);
