...
public interface ProjectNoticeService extends IService<ProjectNotice> {
     ...
     * @return
     */
    void saveByDeviceIds(ProjectNoticeAddVo projectNoticeAddVo);
     ...
     * @param projectNoticeAddVo
     */
    void sendBatch(ProjectNoticeAddVo projectNoticeAddVo);

    Page<ProjectPersonNoticeVo> pageByPerson(Page page, String personId, String type);
}
