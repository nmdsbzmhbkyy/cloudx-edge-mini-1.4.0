...
public interface ProjectDeviceInfoProxyService extends IService<ProjectDeviceInfo> {
     ...
     * @return
     */
    boolean saveOrUpdateDeviceByDeviceCode(ProjectDeviceInfoProxyVo deviceInfoProxyVo);
     ...
     * @return
     */
    ProjectDeviceInfoProxyVo getByDeviceCode(String deviceCode);
     ...
     * @return
     */
    Integer countDeviceCode(String deviceCode);
