...
//		redisTemplate = (RedisTemplate) applicationContext.getBean("openRedisTemplate");
    }
     ...
     * @return 对应的多个键值
     */
    public static<K, V> Map<K, V> hmget(String key, Class<K> keyClass, Class<V> valueClass) {
        Map<K, V> map;
     ...
     * @return true 成功 false 失败
     */
    public static <T extends Serializable> boolean hmsetBySerializable(String key, Map<String, T> map) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            return true;
        } catch (Exception e) {
     ...
     * @return true 成功 false失败
     */
    public static <T extends Serializable> boolean hsetBySerializable(String key, String item, T value) {
        try {
            redisTemplate.opsForHash().put(key, item, value);
            return true;
        } catch (Exception e) {
