...
import com.aurine.cloudx.open.origin.constant.IsFocusPersonConstants;
...
import com.aurine.cloudx.open.origin.feign.RemoteHousePersonRelService;
...
//        }
    ...
    @Override
    public Page<HousePersonInfoVo> page(Page page, HousePersonInfoVo vo) {
        ProjectHousePersonRel po = new ProjectHousePersonRel();
