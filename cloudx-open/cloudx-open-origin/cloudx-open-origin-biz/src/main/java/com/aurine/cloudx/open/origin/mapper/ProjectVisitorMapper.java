...
import com.aurine.cloudx.open.origin.vo.ProjectVisitorRecordVo;
import com.aurine.cloudx.open.origin.vo.ProjectVisitorSearchConditionVo;
...
public interface ProjectVisitorMapper extends BaseMapper<ProjectVisitor> {
     ...
     * @return
     */
    Page<VisitorInfoVo> page(Page page, @Param("query") ProjectVisitor po);
}
