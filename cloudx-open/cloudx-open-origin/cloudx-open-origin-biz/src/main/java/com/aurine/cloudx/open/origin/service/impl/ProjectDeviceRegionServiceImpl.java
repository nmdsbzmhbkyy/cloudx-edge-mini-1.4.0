...
import com.aurine.cloudx.open.origin.entity.ProjectStaffRegion;
import com.aurine.cloudx.open.origin.mapper.ProjectDeviceRegionMapper;
...
public class ProjectDeviceRegionServiceImpl extends ServiceImpl<ProjectDeviceRegionMapper, ProjectDeviceRegion> implements ProjectDeviceRegionService {
    ...
    @Resource
    private ProjectDeviceRegionMapper projectDeviceRegionMapper;
    /**
...
//            }
    ...
    @Override
    public Page<ProjectRegionVo> page(Page page, ProjectRegionVo vo) {
        ProjectDeviceRegion po = new ProjectDeviceRegion();
        BeanUtils.copyProperties(vo, po);

        return projectDeviceRegionMapper.page(page, po);
    }
