...
public interface ProjectRightDeviceService extends IService<ProjectRightDevice> {
     ...
     * @author: 王良俊
     */
    Page<ProjectRightDevice> pageByDeviceId(Page page, ProjectRightDeviceOptsAccessSearchConditionVo query, String deviceId);
     ...
     * </p>
     */
    Integer countDeviceId(String dlStatus, String deviceId);
     ...
     * @return
     */
    Page<RightDeviceRelVo> page(Page page, RightDeviceRelVo vo);
}