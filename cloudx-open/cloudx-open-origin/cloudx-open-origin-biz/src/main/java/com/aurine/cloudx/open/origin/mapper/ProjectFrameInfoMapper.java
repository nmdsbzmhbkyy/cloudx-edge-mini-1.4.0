...
import com.aurine.cloudx.open.origin.dto.ProjectFrameCountDTO;
import com.aurine.cloudx.open.origin.entity.ProjectFrameInfo;
import com.aurine.cloudx.open.origin.vo.FrameInfo;
import com.aurine.cloudx.open.origin.vo.ProjectDeviceSelectTreeVo;
import com.aurine.cloudx.open.origin.vo.ProjectFrameInfoVo;
import com.aurine.cloudx.open.origin.vo.ProjectHouseAddressVo;
...
public interface ProjectFrameInfoMapper extends BaseMapper<ProjectFrameInfo> {
     ...
     * @return
     */
    Page<FrameInfoVo> page(Page page, @Param("query") ProjectFrameInfo po);
}
