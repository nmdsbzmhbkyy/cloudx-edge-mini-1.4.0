...
import com.aurine.cloudx.open.origin.vo.ProjectBuildingRegionInfoVo;
import com.aurine.cloudx.open.origin.vo.ProjectDeviceRegionVo;
import com.aurine.cloudx.open.origin.entity.ProjectDeviceRegion;
import com.aurine.cloudx.open.origin.vo.DeviceRegionInfoVo;
import com.aurine.cloudx.open.origin.vo.ProjectRegionManagerVo;
...
public interface ProjectDeviceRegionMapper extends BaseMapper<ProjectDeviceRegion> {
     ...
     * @author: 王良俊
    */
    Page<ProjectBuildingRegionInfoVo> pageBuildingRegionInfo(Page page, @Param("buildingName") String buildingName, @Param("regionId") String regionId, @Param("regionName") String regionName);
     ...
     * @author: 王良俊
    */
    Page<ProjectBuildingRegionInfoVo> pageBuildingRegionInfoGroup(Page page, @Param("buildingName") String buildingName, @Param("regionId") String regionId, @Param("regionName") String regionName);
    ...
    */
     ...
     * @author: 王良俊
     */
    List<DeviceRegionInfoVo> listAllRegionInfo();
     ...
     * @return
     */
    Page<ProjectRegionVo> page(Page page, @Param("query") ProjectDeviceRegion po);
