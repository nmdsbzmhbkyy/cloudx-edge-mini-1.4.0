...
import com.aurine.cloudx.open.origin.mapper.ProjectVisitorHisMapper;
...
public class ProjectVisitorHisServiceImpl extends ServiceImpl<ProjectVisitorHisMapper, ProjectVisitorHis> implements ProjectVisitorHisService {
    ...
    @Override
    public Page<VisitorHisVo> page(Page page, VisitorHisVo vo) {
        ProjectVisitorHis po = new ProjectVisitorHis();
