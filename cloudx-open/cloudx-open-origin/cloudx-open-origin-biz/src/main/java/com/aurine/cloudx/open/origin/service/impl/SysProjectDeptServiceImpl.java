...
import com.aurine.cloudx.open.origin.constant.enums.DefaultDeptEnum;
import com.aurine.cloudx.open.origin.entity.SysProjectDept;
import com.aurine.cloudx.open.origin.mapper.SysProjectDeptMapper;
import com.aurine.cloudx.open.origin.service.ProjectPersonInfoService;
import com.aurine.cloudx.open.origin.service.SysProjectDeptService;
...
//            dept.setParentId(ProjectContextHolder.getProjectId());
    ...
    @Override
    public IPage<SysProjectDeptVo> page(Page page, SysProjectDeptVo sysProjectDeptVo) {
        return baseMapper.getPage(page,sysProjectDeptVo);
    }
}
