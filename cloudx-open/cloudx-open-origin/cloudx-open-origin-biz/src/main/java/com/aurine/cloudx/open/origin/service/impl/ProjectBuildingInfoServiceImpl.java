...
import com.aurine.cloudx.open.origin.constant.MessageFrameConstant;
import com.aurine.cloudx.open.origin.constant.enums.BuildingUnitTypeEnum;
import com.aurine.cloudx.open.origin.constant.enums.FrameTypeEnum;
import com.aurine.cloudx.open.origin.entity.*;
import com.aurine.cloudx.open.origin.mapper.ProjectBuildingInfoMapper;
    ...
    public boolean saveBatch(ProjectBuildingBatchVo buildingBatchVo) {
        ...
        for (ProjectBuildingBatchBuildingVo buildingVo : buildingBatchVo.getBuildingList()) {
            ...
            for (ProjectBuildingBatchUnitVo unitVo : buildingVo.getUnitList()) {
                ...
                this.projectUnitInfoService.saveUnit(unitPo, buildingId);
...
//        }
        ...
        ProjectBuildingInfo projectBuildingInfo = new ProjectBuildingInfo();
        BeanUtils.copyProperties(projectBuildingInfoVo, projectBuildingInfo);
        if (projectBuildingInfoVo.getFloorTotal() == null) {
            baseMapper.updateFloorTotal(projectBuildingInfoVo.getBuildingId());
        }
    ...
    @Override
    public Page<BuildingInfoVo> page(Page page, BuildingInfoVo vo) {
        ProjectBuildingInfo po = new ProjectBuildingInfo();
