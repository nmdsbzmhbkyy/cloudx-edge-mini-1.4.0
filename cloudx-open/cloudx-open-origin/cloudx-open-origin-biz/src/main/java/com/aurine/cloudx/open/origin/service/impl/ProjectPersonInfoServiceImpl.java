...
import com.aurine.cloudx.open.origin.mapper.ProjectPersonInfoMapper;
...
public class ProjectPersonInfoServiceImpl extends ServiceImpl<ProjectPersonInfoMapper, ProjectPersonInfo> implements ProjectPersonInfoService {
    ...
    @Resource
    private ProjectPersonInfoMapper projectPersonInfoMapper;
...
//                .eq(ProjectPersonInfo::getPStatus, "1"));
    ...
    public Integer getAssetsNum(String personId) {
        return this.baseMapper.getAssetsNum(personId);
    }

    @Override
    public List<PersonAssetsNumVo> getAssetsNum(List<String> personIdList) {
        return this.baseMapper.getAssetsNumVoList(personIdList);
    }
    ...
    @Override
    public Page<PersonInfoVo> page(Page page, PersonInfoVo vo) {
        ProjectPersonInfo po = new ProjectPersonInfo();
        BeanUtils.copyProperties(vo, po);

        return projectPersonInfoMapper.page(page, po);
    }
