 ...
 */
@Data
@TableName(value = "project_open_lane_his", schema = "aurine_parking")
@EqualsAndHashCode(callSuper = true)
@AllArgsConstructor
@NoArgsConstructor
public class ProjectOpenLaneHis extends OpenBasePo<ProjectOpenLaneHis> {
    ...
    /*
     * 开闸类型 0 不会自动关闸 1 会自动关闸（带关闸事件上报）
     **/
    @ApiModelProperty("开闸类型 0 不会自动关闸 1 会自动关闸（带关闸事件上报）")
