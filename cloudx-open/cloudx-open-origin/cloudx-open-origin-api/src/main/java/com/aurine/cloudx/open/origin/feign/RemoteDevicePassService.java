...
import com.aurine.cloudx.open.origin.dto.ProjectDevicePassQRDTO;
 ...
 * @date 2020/12/9 8:55
 */
@FeignClient(contextId = "openRemoteDevicePassService", value = ServiceNameConstants.ESTATE_SERVICE)
