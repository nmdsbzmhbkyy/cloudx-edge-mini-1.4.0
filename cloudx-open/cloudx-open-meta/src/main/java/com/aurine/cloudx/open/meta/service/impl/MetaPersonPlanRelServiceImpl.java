...
@Service
public class MetaPersonPlanRelServiceImpl implements MetaPersonPlanRelService {
    ...
    @Override
    public R<ProjectPersonPlanRel> save(ProjectPersonPlanRel po) {
        boolean result = projectPersonPlanRelService.saveOrUpdate(po);
    ...
    @Override
    public R<ProjectPersonPlanRel> update(ProjectPersonPlanRel po) {
        boolean result = projectPersonPlanRelService.saveOrUpdate(po);
    ...
    public R<Boolean> delete(String id) {
        boolean result = projectPersonPlanRelService.removeById(id);
