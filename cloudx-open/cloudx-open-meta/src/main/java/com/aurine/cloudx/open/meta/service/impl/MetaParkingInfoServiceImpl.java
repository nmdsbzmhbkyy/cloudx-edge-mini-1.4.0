...
@Service
public class MetaParkingInfoServiceImpl implements MetaParkingInfoService {
    ...
    @Override
    public R<ProjectParkingInfo> save(ProjectParkingInfo po) {
        boolean result = projectParkingInfoService.saveOrUpdate(po);
    ...
    @Override
    public R<ProjectParkingInfo> update(ProjectParkingInfo po) {
        boolean result = projectParkingInfoService.saveOrUpdate(po);
    ...
    public R<Boolean> delete(String id) {
        boolean result = projectParkingInfoService.removeById(id);
